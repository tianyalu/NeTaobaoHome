## NeTaobaoHome 用vlayout实现的仿淘宝首页
### 一、vlayout 
1. github地址：[https://github.com/alibaba/vlayout](https://github.com/alibaba/vlayout) 
2. vlayout布局方式：
![image](https://github.com/tianyalu/NeTaobaoHome/blob/master/show/layout_pattern.png)  
3. vlayout优点：  
![image](https://github.com/tianyalu/NeTaobaoHome/blob/master/show/vlayout_feature.png)  
...
```
#### 注意：一定要在`BaseDelegateAdapter`中重写`getItemViewType(int position)`方法，否则可能出现滑动不流畅问题  
```android 
    /**
     * 必须重写，不然会出现滑动不流畅的问题
     * @param position
...
### 三、演示示例
![image](https://github.com/tianyalu/NeTaobaoHome/blob/master/show/show.gif)  
